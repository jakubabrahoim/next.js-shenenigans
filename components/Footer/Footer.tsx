import { AiOutlineMail, AiOutlineInstagram, AiOutlineLinkedin, AiOutlineGithub } from 'react-icons/ai';
        ...
        <footer className='flex w-screen max-w-6xl justify-center pt-2 sm:mx-auto sm:justify-end'>
            <section className='mr-4 flex items-center justify-center'>
                ...
                <a href='https://linkedin.com/in/jakub-abrahoim-b03011196' target='_blank' rel='noreferrer'>
                    <ReactIcon icon={<AiOutlineLinkedin />} iconClass='mr-1.5 w-6 h-6 hover:text-orchid-200 transition duration-500 cursor-pointer'/>
                </a>
                <a href='https://github.com/jakubabrahoim' target='_blank' rel='noreferrer'>
                    <ReactIcon icon={<AiOutlineGithub />} iconClass='w-6 h-6 hover:text-orchid-200 transition duration-500 cursor-pointer'/>
                </a>
            </section>
        </footer>
    );
