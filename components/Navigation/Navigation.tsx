...
const Navigation = (props: Props) => {
    ...
    return (
        <header>
            ...
            <button
                className={`ml-6 block pt-6 sm:hidden ${
                    isMobileMenuOpen && "mb-2"
                }`}
            ...
            >
                {!isMobileMenuOpen ? (
                    <ReactIcon
                        icon={<AiOutlineMenu />}
                        iconClass="w-7 h-7 text-jet-200 font-semibold text-xl"
                    />
                ) : (
                    <ReactIcon
                        icon={<VscChromeClose />}
            ...
            <nav className="ml-3 flex max-w-6xl items-center justify-between pt-2 sm:mx-auto">
                ...
                <div
                    className={`${
                        !isMobileMenuOpen ? "hidden" : "flex flex-col space-y-1"
